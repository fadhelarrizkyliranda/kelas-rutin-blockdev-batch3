// Script untuk men-deploy CampusCredit contract
...
async function main() {
  try {
    ...
    console.log(`Deploying CampusCredit to ${network} network...`);
    ...
    console.log(`CampusCredit deployed successfully to: ${contractAddress}`);
